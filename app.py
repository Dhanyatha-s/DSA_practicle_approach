...
# # 🔧 Smaller Area for Speed (Bounding Box)
# north, south, east, west = 12.96, 12.93, 77.61, 77.59
# with st.spinner("Downloading smaller area map..."):
...
# # 📍 Inputs
# st.markdown("### Enter Start & End Coordinates (within above area)")

# col1, col2 = st.columns(2)
# with col1:
#     start_lat = st.number_input("Start Latitude", value=12.954)
#     start_lon = st.number_input("Start Longitude", value=77.598)
# with col2:
#     end_lat = st.number_input("End Latitude", value=12.935)
#     end_lon = st.number_input("End Longitude", value=77.605)
...
# # 🚀 Optimized A* with heapq + light animation
# if st.button("🔍 Find Route"):
#     with st.spinner("Running fast A*..."):
...
#             # 🔄 Animate every 50 steps
#             steps += 1
#             if steps % 50 == 0:
#                 fig, ax = ox.plot_graph_routes(
#                     G, [visited], route_colors='orange',
#                     route_linewidth=1, node_size=0, show=False, close=False
#                 )
#                 container.pyplot(fig)

#         # ✅ Final route
#         if path:
#             fig, ax = ox.plot_graph_route(G, path, route_color='red', node_size=0)
